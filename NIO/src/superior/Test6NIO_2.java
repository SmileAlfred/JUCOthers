...
//		Files.createFile(file);
    ...
    public void test3() throws IOException {
        Path path1 = Paths.get("e:/AJ_Data/readme.txt");
        Path path2 = Paths.get("e:/AJ_Data/readme2.txt");
    ...
    @Test
    public void test2() {
        Path path = Paths.get("e:/AJ_Data/readme.txt");
    ...
    public void test1() {
        ...
        System.out.println(path.endsWith("readme.txt"));
        System.out.println(path.startsWith("e:/"));

        System.out.println(path.isAbsolute());
        System.out.println(path.getFileName());

        for (int i = 0; i < path.getNameCount(); i++) { //AJ_Data
            System.out.println(path.getName(i));        //readme.txt
        }
    }
}
